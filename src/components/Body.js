...
//
  ...
  ?(<div className="shimmer-main-container">{Array(12).fill('').map((x,index)=>
  <Shimmer key={index}/>)}</div>)
  :(
     <>
     <div className="searchBar">
          <input name="searchBar" value={searchValue} placeholder="Serach"
           onChange={(e)=>{
